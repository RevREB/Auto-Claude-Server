...
describe('OAuthStep Profile Management Logic', () => {
  beforeEach(() => {
    ...
    if (window.api) {
      window.api.getClaudeProfiles = mockGetClaudeProfiles;
      window.api.saveClaudeProfile = mockSaveClaudeProfile;
      window.api.deleteClaudeProfile = mockDeleteClaudeProfile;
      window.api.renameClaudeProfile = mockRenameClaudeProfile;
      window.api.setActiveClaudeProfile = mockSetActiveClaudeProfile;
      window.api.initializeClaudeProfile = mockInitializeClaudeProfile;
      window.api.setClaudeProfileToken = mockSetClaudeProfileToken;
      window.api.onTerminalOAuthToken = mockOnTerminalOAuthToken;
    }
  ...
  describe('Add Profile Flow', () => {
    it('should call saveClaudeProfile with correct parameters', async () => {
      ...
      const result = await window.api.saveClaudeProfile(newProfile);
    ...
    it('should call initializeClaudeProfile after saving profile', async () => {
      ...
      await window.api.saveClaudeProfile(newProfile);
      await window.api.initializeClaudeProfile(newProfile.id);
  ...
  describe('OAuth Authentication Flow', () => {
    it('should call initializeClaudeProfile to trigger OAuth flow', async () => {
      ...
      const result = await window.api.initializeClaudeProfile(profileId);
    ...
    it('should handle initializeClaudeProfile failure', async () => {
      ...
      const result = await window.api.initializeClaudeProfile('profile-1');
      expect(result.success).toBe(false);
    });
    ...
    it('should register OAuth token callback', () => {
      ...
      const unsubscribe = window.api.onTerminalOAuthToken(callback);
  ...
  describe('Set Active Profile', () => {
    ...
    it('should handle setActiveClaudeProfile failure', async () => {
      ...
      const result = await window.api.setActiveClaudeProfile('invalid-id');
      expect(result.success).toBe(false);
    });
  });
  ...
  describe('Rename Profile', () => {
    it('should call renameClaudeProfile with correct parameters', async () => {
      ...
      const result = await window.api.renameClaudeProfile(profileId, newName);
  ...
  describe('Manual Token Entry', () => {
    it('should call setClaudeProfileToken with token and email', async () => {
      ...
      const result = await window.api.setClaudeProfileToken(profileId, token, email);
    ...
    it('should call setClaudeProfileToken with token only (no email)', async () => {
      ...
      const result = await window.api.setClaudeProfileToken(profileId, token, undefined);
  ...
  describe('Error Handling', () => {
    it('should handle getClaudeProfiles failure gracefully', async () => {
      ...
      await expect(window.api.getClaudeProfiles()).rejects.toThrow('Network error');
    });
