...
export function AppUpdateNotification() {
  ...
  useEffect(() => {
    const cleanup = window.api.onAppUpdateAvailable((info) => {
      setUpdateInfo(info);
      setIsOpen(true);
  ...
  useEffect(() => {
    const cleanup = window.api.onAppUpdateDownloaded((_info) => {
      setIsDownloading(false);
  ...
  useEffect(() => {
    const cleanup = window.api.onAppUpdateProgress((progress) => {
