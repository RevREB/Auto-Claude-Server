 ...
 * Guides users through authenticating with Claude using the full login flow
 * which requests all required scopes including user:profile for usage tracking.
 */
export function ClaudeOAuthFlow({ onSuccess, onCancel }: ClaudeOAuthFlowProps) {
  ...
  const handleStartAuth = async () => {
    ...
    try {
      ...
      // Initialize the profile - this starts the OAuth flow with proper scopes
                ...
                <div className="flex items-start gap-2">
                  ...
                  <div className="text-xs text-muted-foreground space-y-1">
                    ...
                    <ol className="list-decimal list-inside space-y-1 ml-2">
                      <li>The OAuth flow has started</li>
                      <li>Your browser should open to authenticate with Claude</li>
                      <li>Complete the OAuth flow in your browser</li>
                      <li>Your token will be automatically saved with all required permissions</li>
                    </ol>
                  </div>
                </div>
              </div>
