...
export function TaskDetailPanel({ task, onClose }: TaskDetailPanelProps) {
  ...
  const handleMerge = async () => {
    ...
    try {
      ...
      console.log('[TaskDetailPanel] merge result:', result);
      if (result.success) {
        // For stage-only: don't close the panel, show success message
        // For full merge: close the panel (store update comes via WebSocket broadcast)
        ...
        console.log('[TaskDetailPanel] Merge failed:', result.message);
  ...
  const handleDiscard = async () => {
    ...
    try {
      ...
      console.log('[TaskDetailPanel] discard result:', result);
      if (result.success) {
      ...
      console.error('[TaskDetailPanel] handleDiscard exception:', error);
