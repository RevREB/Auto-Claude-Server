...
export function WorkspaceStatus({
  ...
  console.log('[WorkspaceStatus] RENDERED - isMerging:', isMerging, 'isDiscarding:', isDiscarding, 'onMerge:', typeof onMerge);
      ...
      <div className="px-4 py-3 bg-muted/20 border-t border-border space-y-3">
        ...
        <div className="flex gap-2">
          <Button
            ...
            onClick={() => {
              console.log('[WorkspaceStatus] Merge button clicked!');
              console.log('[WorkspaceStatus] isMerging:', isMerging, 'isDiscarding:', isDiscarding);
              onMerge();
            }}
