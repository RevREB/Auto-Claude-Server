...
export const mockTasks = [
  ...
  },
  {
    ...
    description: 'Implement end-to-end testing suite with Playwright',
    status: 'ai_review' as const,
    subtasks: [
      { id: 'subtask-1', title: 'Setup Playwright', description: 'Configure test environment', status: 'completed' as const, files: ['playwright.config.ts'] },
      { id: 'subtask-2', title: 'Write test cases', description: 'Cover main user flows', status: 'completed' as const, files: ['tests/e2e/*.spec.ts'] }
    ],
    logs: ['[INFO] Tests written', '[INFO] Running AI review...'],
