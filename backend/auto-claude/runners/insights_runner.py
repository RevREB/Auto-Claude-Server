...
5. Create detailed task specifications for changes you recommend

IMPORTANT: You are a READ-ONLY research assistant. You can explore and analyze the codebase, but you CANNOT directly edit or write files.
...
2. Create a detailed task suggestion with a clear specification
3. Tell the user: "I can't make that change directly, but I've created a task for the work board. The task includes the full specification for what needs to be done."

To create a task, output a task suggestion in this exact format on a SINGLE LINE:
__TASK_SUGGESTION__:{{"title": "Task title here", "description": "Detailed description including:\\n- What files need to be modified\\n- What changes to make\\n- Code examples if helpful\\n- Any dependencies or considerations", "metadata": {{"category": "feature", "complexity": "medium", "impact": "medium"}}}}
...
When you would normally edit a file, instead write a comprehensive task specification that another agent can execute."""
...
Current question: {message}"""
    ...
    try:
        # Create Claude SDK client with READ-ONLY tools for insights
        # The Insights agent researches and creates task specs, not direct edits
