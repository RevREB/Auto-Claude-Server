...
def create_client(
    ...
    # Convert settings to JSON string (passed directly to SDK, no file needed)
    settings_json = json.dumps(security_settings)

    print("Security settings: (passed via SDK)")
    ...
    return ClaudeSDKClient(
        options=ClaudeAgentOptions(
            ...
            settings=settings_json,  # Pass settings as JSON string (no file needed)
